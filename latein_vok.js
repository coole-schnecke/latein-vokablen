...
var fabeln1_1w6 = new vokabel('loqui', 'sprechen', 'loquor, locutus sum');
...
var plinius2w5 = new vokabel('ascendere', 'besteigen, steigen auf', 'ascendo, ascendi, ascensum');
var plinius2w6 = new vokabel('descendere', 'hinuntersteigen', 'descendo, descendi, descensum');
var plinius2w7 = new vokabel('conspicere', 'erblicken, sehen', 'conspicio, conspexi, conspectum');
var plinius2w8 = new vokabel('cognoscere', 'kennenlernen, erkennen, erfahren, bemerken', 'cognosco, cognovi, cognitum');
var plinius2w9 = new vokabel('oriri', 'entstehen; sich zeigen', 'orior, ortus sum (Dep.)');
...
var plinius2w17 = new vokabel('cinis', 'Asche', 'cineris n.');
...
var plinius2w21 = new vokabel('calidus', 'warm, heiß', '-a, -um');
